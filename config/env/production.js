  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      url: 'postgresql://winiuser:DM3E6fx!]{g2BB(~=^rNcQ[=@localhost:5432/winidb',
      //--------------------------------------------------------------------------
...
module.exports.emailCredentials = {
  email: 'santiago.wini89@gmail.com',
  password: 'wini010100'
};

module.exports.emailContact = {
  contact: 'santiago@fernandezyrubi.com',
  report: 'santiago@fernandezyrubi.com'
};
